...
class Attendance:
    def __init__(self,root):
        ...
        img=img.resize((700,130),PIL.Image.Resampling.LANCZOS)
...
#second image
        ...
        img1=img1.resize((700,130),PIL.Image.Resampling.LANCZOS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        f_lbl=Label(self.root,image=self.photoimg1)
        f_lbl.place(x=700,y=0,width=700,height=130)
...
#bg image
   ...
   #left label frame
        ...
        img_left=img_left.resize((600,110),PIL.Image.Resampling.LANCZOS)
        ...
        left_inside_frame.place(x=0,y=125,width=610,height=250)

    #attendanceid
        attendanceId_label=Label(left_inside_frame,text="AttendanceId:",font=("times new roman",12,"bold"))
        attendanceId_label.grid(row=0,column=0,padx=8,sticky=W)
        
        attendanceId_entry=ttk.Entry(left_inside_frame,width=18,textvariable=self.var_atten_id,font=("timew new roman",10))
    ...
    #Roll
        ...
        atten_roll=ttk.Entry(left_inside_frame,width=18,textvariable=self.var_atten_roll,font=("timew new roman",10))
    ...
    #NAme
        ...
        atten_name=ttk.Entry(left_inside_frame,width=18,textvariable=self.var_atten_name,font=("timew new roman",10))
    ...
    #department
        ...
        atten_dep=ttk.Entry(left_inside_frame,width=18,textvariable=self.var_atten_dep,font=("timew new roman",10))
     ...
     #Time
        ...
        atten_time=ttk.Entry(left_inside_frame,width=18,textvariable=self.var_atten_time,font=("timew new roman",10))
    ...
    #Date
        ...
        atten_date=ttk.Entry(left_inside_frame,width=18,textvariable=self.var_atten_date,font=("timew new roman",10))
        atten_date.grid(row=2,column=3,padx=5,pady=5,sticky=W)

     #attendance
        attendance_label=Label(left_inside_frame,text="Attendance Status",font=("times new roman",12,"bold"))
        attendance_label.grid(row=3,column=0)
        
        self.atten_status=ttk.Combobox(left_inside_frame,width=20,textvariable=self.var_atten_attendance,font=("timew new roman",10))
...
#button frame
        ...
        save_btn=Button(btn_frame,text="Import csv",width=15,command=self.importCsv,font=("times new roman",12,"bold"),bg="blue",fg="white")
